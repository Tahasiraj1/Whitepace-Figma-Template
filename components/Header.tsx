...
const Header = () => {
  return (
    <header className='flex items-center bg-[#043873] py-[16px] sm:p-[16px] xl:px-[32px] 2xl:px-[220px] justify-between'>
        ...
        <nav>
            <ul className='flex gap-4 2xl:flex xl:flex lg:hidden md:hidden sm:hidden'>
        ...
        <div className='flex items-center justify-center gap-4'>
            <button className='font-semibold bg-[#FFE492] text-[#043873] rounded-lg w-[126px] h-[60px] flex items-center justify-center 2xl:flex xl:flex lg:flex md:hidden sm:hidden'>
                Login
            </button>
            <button className='font-semibold bg-[#4F9CF9] text-white rounded-lg w-[227px] h-[60px] flex items-center justify-center gap-2 2xl:flex xl:flex lg:flex md:hidden sm:hidden'>
